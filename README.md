# Word2Vec--numpy
A Word2Vec skip-gram model with negative sampling implemented from scratch in Python using NumPy. It learns word embeddings, computing word similarity, and performs analogy tests without using any ML frameworks.
